...
| `000005` | `doctor_fixed_fees` | Fixed fees for Dr. Name4 |
...
| `000015` | `doctor_lab_billings` | Per-doctor JOB rules (Name3 subset; Name4 none) |
...
Customer data migration from `database/database.sqlite` to PostgreSQL: `php artisan app:migrate-sqlite-to-pgsql` (operator notes are local-only).
