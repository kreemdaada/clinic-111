...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .topbar-nav a { color: #cbd5e1; font-size: 0.9rem; text-decoration: none; }
        .topbar-nav a.active, .topbar-nav a:hover { color: #fff; }
        .topbar-user { color: #94a3b8; font-size: 0.85rem; margin-right: 0.5rem; }
        .btn-logout {
        ...
        .page-subtitle { color: #64748b; margin-bottom: 1.5rem; font-size: 0.95rem; }
        .card {
            background: #fff;
            border-radius: 10px;
        ...
        .log-box .empty { color: #64748b; font-style: italic; }
    </style>
    @stack('styles')
</head>
<body>
